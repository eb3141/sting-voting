...
def init_firestore():
    ...
    try:
        ...
        creds_data = st.secrets.get("google_credentials")
        ...
        if isinstance(creds_data, str) and len(creds_data) > 100:
            # Likely base64 encoded
            try:
                creds_dict = json.loads(base64.b64decode(creds_data))
            except:
                # Try as raw JSON if base64 fails
